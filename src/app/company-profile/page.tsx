  ...
  const caseStudies = [
    {
      ...
      metric: "Launched",
      description: "Mindfulness and content platform with guided courses, modern UX, and conversion-focused design."
    },
    {
      title: "Diyans.com",
      industry: "E-commerce",
      metric: "Live",
      description: "Full eCommerce website with sleek design and optimized checkout experience for higher conversions."
    },
    {
      title: "Exelora SaaS",
      industry: "Technology",
      metric: "Active",
      description: "Modular SaaS platform with AI-driven content creation, SEO automation, lead gen, and email campaigns."
    }
  ];

  const teamMembers = [
    {
      name: "Engr Fazal Subhan PMP",
      role: "CEO & Founder",
      expertise: "AI Strategy, Project Management, Full-Stack Development, Business Innovation"
    }
  ];
    ...
    <div className="min-h-screen bg-gray-100 py-8">
          ...
          <div className="section-intro">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">6+ Completed Projects</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-green-600" />
      ...
      <div className="pdf-page">
        <div className="profile-section">
          ...
          <p className="body-text">
            Real results from real clients. Our projects showcase premium web development 
            and automation/AI solutions that deliver measurable impact.
          </p>
          ...
          <div className="section-intro">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 mb-2">PHTCC.ae</div>
                <div className="text-sm text-gray-600">UAE Contracting Website</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 mb-2">FDRB.ae</div>
                <div className="text-sm text-gray-600">Corporate Website</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 mb-2">Orbdeep.com</div>
                <div className="text-sm text-gray-600">Digital Ventures Site</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 mb-2">n8n Automations</div>
                <div className="text-sm text-gray-600">Workflow Solutions</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="pdf-page">
        <div className="profile-section">
          ...
          <p className="body-text">
            Meet the visionary leader behind ORBIS CR's innovative AI-powered solutions 
      ...
      <div className="pdf-page">
        <div className="profile-section">
          ...
          <p className="body-text">
            Our comprehensive technology expertise spans multiple programming languages, 
            frameworks, databases, and cloud platforms to deliver world-class solutions.
          </p>
      ...
      <div className="pdf-page">
        <div className="profile-section">
          ...
          <div className="section-intro">
            ...
            <p className="body-text">
              Join businesses that have transformed with our AI-powered solutions. 
